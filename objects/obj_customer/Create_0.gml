...
drink = drinks[irandom_range(0, array_length(drinks) - 1)]
race = races[irandom_range(0, array_length(races) - 1)]
...
sprite_index = sprite_array[irandom_range(0, array_length(sprite_array) - 1)]
...
patience = 100
patience_bar = instance_create_depth(x - 20, y - 20, -9, obj_patience_bar)